...
class CallbackRegistration:
    ...
    on_step_start: Callable[[str, str], None] | None = None  # step_id, step_name
    on_step_complete: Callable[[str, dict[str, Any]], None] | None = None  # step_id, result
...
class CallbackRegistry:
    ...
    def register(
        ...
        logger.info(
            f"📞 注册回调: {reg_id} | 会话: {conversation_id}"
...
_callback_registry_instance: CallbackRegistry | None = None

...
DOMAIN_KEYWORD_MAP = {
    ...
    "AI/LLM": [
        "Ponytail", "MCP", "LLM", "RAG", "Agent", "Prompt", "大模型",
        "机器学习", "深度学习", "NLP", "Ollama", "OpenAI", "AI", "ML",
        "GPT", "Claude", "FastMCP", "模型", "推理", "向量", "Embedding",
        "对话分析", "知识图谱",
    ],
    # 前端
    "前端": [
        "前端", "Frontend", "React", "Vue", "JavaScript", "TypeScript",
        "HTML", "CSS", "Webpack", "Vite", "Node", "UI", "组件", "浏览器",
        "DOM", "dom", "前后端联调",
    ],
    # Python
    "Python": [
        "Python", "Django", "FastAPI", "Flask", "pip", "conda", "pytest",
        "py", "后端开发", "后端", "Pythonic", "环境管理", "多线程编程",
    ],
    # DevOps
    "DevOps": [
        "DevOps", "Docker", "Kubernetes", "CI/CD", "Linux", "Nginx",
        "Git", "部署", "运维", "容器", "Shell", "cron", "GitHub",
    ],
    # 数据库
    "数据库": [
        "SQL", "MySQL", "PostgreSQL", "SQLite", "Redis", "MongoDB",
        "数据库", "ORM", "SQLAlchemy", "索引", "查询优化", "WAL",
    ],
    # 架构设计
    "架构设计": [
        "架构", "设计模式", "系统设计", "微服务", "异步", "并发",
        "管道", "队列", "设计", "SOLID", "系统架构", "指数退避",
        "API设计", "重构",
    ],
    # 通用工程
    "通用工程": [
        "代码质量", "安全", "调试", "测试", "文档", "问题定位", "工程",
        "最佳实践", "编码规范", "YAGNI", "DRY", "清理",
        "新技术", "数据生命周期", "devpartner",
    ],
}
